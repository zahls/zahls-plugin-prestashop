...
class ZahlsApiService
{
     ...
     * @return Gateway|null
     */
    public function getZahlsGateway($gatewayId): ?Gateway
    {
        if (!$gatewayId) {
            return null;
        }
    ...
    public function getTransactionByGateway($zahlsGateway): ?Transaction
    {
        ...
        return $this->getZahlsTransaction(end($transactions)['id']);
    }
     ...
     */
    public function getZahlsTransaction($transactionId): ?Transaction
    {
        if (!$transactionId) {
            return null;
        }
    ...
    public function createZahlsGateway(
        float $total,
        string $currency,
        array $redirectUrls,
        $cart,
    ...
    public function deleteZahlsGateway($gatewayId)
    {
        $zahls = $this->getInterface($this->instanceName, $this->apiKey, $this->platform);
