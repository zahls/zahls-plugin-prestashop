...
class zahls.chzahls.chModuleFrontController extends ModuleFrontController
{
    ...
    public function postProcess()
    {
        try {
            ...
            if ($gatewayId = $zahlsDbService->getCartGatewayId($cart->id)) {
                $zahlsApiService->deletezahls.chGateway($gatewayId);
            }
            ...
            $gateway = $zahlsApiService->createzahls.chGateway(
                $total,
                $currencyIsoCode,
                $redirectUrls,
                $cart,
